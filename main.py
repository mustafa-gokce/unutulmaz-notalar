...
application = flask.Flask(name_application,
                          static_folder=os.path.abspath("/home/m/unutulmaz-notalar/static/"),
                          static_url_path="/download_file/")
...
if __name__ == "__main__":
    ...
    try:
        ...
        application.logger.info("Frontend Server Manager starting using Werkzeug WSGI on port 80...")
    ...
    # permission error handling
        ...
        application.logger.info("Frontend Server Manager starting using Werkzeug WSGI on port 8080...")
